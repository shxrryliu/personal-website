    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
            ...
            <div className='max-w-3xl w-full p-4 md:mx-auto mx-3 sm:mt-12 mt-8'>
                ...
                {/* problem statement */}
                <h3 className='pt-10 pb-4 text-xl font-medium text-blue-900'>the problem</h3>
                <p className='text-gray-700'>
            ...
            <div className='max-w-3xl w-full p-4 md:mx-auto mx-3'>
                <h3 className='mb-8 text-3xl font-medium text-blue-900 text-center'>Weeks 1-4: Research.</h3>

                {/* user research */}
                <h3 className='mb-4 text-xl font-medium text-blue-900'>background research & focus group analysis</h3>
                <p className='text-gray-700 my-4'>
                ...
                <h3 className='mt-10 mb-4 text-xl font-medium text-blue-900'>affinity group analysis</h3>
                <p className='text-gray-700 my-4'>
                ...
                {/* KEY INSIGHTS */}
                <h3 className='mt-10 mb-4 text-xl font-medium text-blue-900'>key insights & pain points</h3>
                <p className='text-gray-700 my-4'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className='p-4 bg-gray-100 rounded-md shadow-md'>
                        <h3 className="font-medium text-lg mb-3 text-blue-800">Inconsistent Data Collection</h3>
                    ...
                    <div className='p-4 bg-gray-100 rounded-md shadow-md'>
                        <h3 className="font-medium text-lg mb-3 text-blue-800">Challenges Analyzing Data</h3>
                        <p className="text-gray-600">
                    ...
                    <div className='p-4 bg-gray-100 rounded-md shadow-md'>
                        <h3 className="font-medium text-lg mb-3 text-blue-800">Sharing with Community</h3>
                        <p className="text-gray-600">
                            Currently, community organizers are the only ones seeing the data they collect — there is no form of community engagement.
                        </p>
                    </div>
                    <div className='p-4 bg-gray-100 rounded-md shadow-md'>
                        <h3 className="font-medium text-lg mb-3 text-blue-800">Promoting Community Activism</h3>
                        <p className="text-gray-600">
                ...
                <ul className='list-disc list-inside mx-8 text-gray-700'>
                    <li className='my-2'>
                        <b className='text-blue-800'>Tech-Averse Attitudes</b>: Several users described a lack of formal training while onboarding new tech tools, and teaching people to use
                    ...
                    <li className='my-2'>
                        <b className='text-blue-800'>Challenges with Building Relationships</b>: Users also noted a lack of opportunities for building interpersonal relationships with students,
                    ...
                    <li className='my-2'>
                        <b className='text-blue-800'>Tracking & Logistical Challenges</b>: Users also mentioned wanting an all-inclusive platform to track various parts of their work, ranging
            ...
            {/* IDEATION */}
            <div className='max-w-3xl w-full p-4 md:mx-auto mx-3'>
                <h3 className='mb-8 text-3xl font-medium text-blue-900 text-center'>Weeks 4-8: Ideation.</h3>

                {/* ideation */}
                <h3 className='mt-10 mb-4 text-xl font-medium text-blue-900'>feature ideation</h3>
                <p className='text-gray-700 my-4'>
                    Based on these pain points, we determined the top features in our scope:
                    <ul className='list-disc list-inside mx-8 text-gray-700 font-medium my-3'>
                        <li className='my-2'>
                            <b className='text-blue-800'>A reporting database</b> to track and report instances of discrimination
                            or police presence at schools.
                        </li>
                        <li className='my-2'>
                            <b className='text-blue-800'>A heat mapping tool leading into top-level regional insights</b>, which
                            allows students and organizers to monitor trends based on geographic cluster.
                        </li>
                        <li className='my-2'>
                            <b className='text-blue-800'>A local discussion board</b> for all community members to engage on discussion
                ...
                {/* sprint 1 */}
                <h3 className='mt-10 mb-4 text-2xl font-medium text-blue-900 text-center italic'>Sprint 1</h3>
                <p className='text-gray-700 my-4'>
                ...
                {/* reporting database */}
                <h3 className='mt-12 mb-4 text-xl font-medium text-blue-900'>feature 1: reporting database</h3>
                <p className='text-gray-700 my-4'>
                ...
                <h3 className='mt-12 mb-4 text-xl font-medium text-blue-900'>feature 2: heatmap with top-level insights</h3>
                <p className='text-gray-700 my-4'>
                    ...
                    location would show relevant top-level insights, with deeper analytics nested further.
                </p>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>heatmap showing report density</p>
                    </div>
                    <div>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>at-a-glance insights</p>
                    </div>
                    <div>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>reports with tags</p>
                    </div>
                    <div>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>filters</p>
                    </div>
                    <div>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>high-level trends [potential for AI use here]</p>
                    </div>
                    <div>
                ...
                ease-in-out transform hover:-translate-y-1'/>
                        <p className='text-center text-gray-700 mt-2'>data visualizations for each district</p>
                    </div>
                </div>

                <h3 className='mt-12 mb-4 text-xl font-medium text-blue-900'>feature 3: local discussion board</h3>
                <p className='text-gray-700 my-4'>
                    In the first half of our <b>12-week cycle</b>, we scoped 8 existing reporting, mapping tools,
                    and discussion platforms such as Snapchat, Google Maps, Waze, and Reddit, and reviewed
                    <b> 5 focus group recordings with 12 community leaders</b>, with analysis focused on <b> user-centered design strategies</b>.
                ...
                <h3 className='mt-12 mb-4 text-xl font-medium text-blue-900'>usability testing</h3>
                <p className='text-gray-700 my-4'>
                    In the first half of our <b>12-week cycle</b>, we scoped 8 existing reporting, mapping tools,
                    and discussion platforms such as Snapchat, Google Maps, Waze, and Reddit, and reviewed
                    <b> 5 focus group recordings with 12 community leaders</b>, with analysis focused on <b> user-centered design strategies</b>.
            ...
            <div className='max-w-3xl w-full p-4 md:mx-auto mx-3'>
                <h3 className='mb-8 text-3xl font-medium text-blue-900 text-center'>Weeks 8-12: Final Design Solution.</h3>

                {/* home page */}
                <h3 className='mt-10 mb-4 text-xl font-medium text-blue-900'>usability testing</h3>
                <p className='text-gray-700 my-4'>
                    In the first half of our <b>12-week cycle</b>, we scoped 8 existing reporting, mapping tools,
                    and discussion platforms such as Snapchat, Google Maps, Waze, and Reddit, and reviewed
                    <b> 5 focus group recordings with 12 community leaders</b>, with analysis focused on <b> user-centered design strategies</b>.
