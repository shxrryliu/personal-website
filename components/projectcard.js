...
const ProjectCard = ({ project, className, imgClassName }) => {
  return (
    <Link href={project.link} passHref className={`bg-gray-100 rounded-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 overflow-hidden ${className}`}>
